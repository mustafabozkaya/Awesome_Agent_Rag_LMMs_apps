...
with col1:
    repo = st.text_input("Repository", value="YourUsername/Awesome_Agent_Rag_LMMs_apps", help="Format: owner/repo")
with col2:
...
if 'result' not in locals():
    st.markdown(
        ...
        <ol>
            ...
            <li>Specify a repository (e.g., YourUsername/Awesome_Agent_Rag_LMMs_apps)</li>
